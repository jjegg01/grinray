...
use grinray::{
    ...
    CheckerboardMaterial, DebuggerTracer, LinearGRINFresnelMaterial, Scene, Tracer,
};
...
fn main() {
    ...
    // let hemisphere_transform = ObjectTransform::with_translation((0.0, 0.0, -2.0).into());
    let hemisphere_transform = ObjectTransform::new(
    ...
    scene.add_object(Box::new(hemisphere), hemisphere_transform, lambert_mat);
    // Create camera
