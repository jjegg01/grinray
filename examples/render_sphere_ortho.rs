...
use cgmath::Vector3;
use grinray::{
    graphics::{Camera, OrthographicCamaraParameters, OrthographicCamera, RayGraphicsContext}, objects::{ObjectTransform, Plane, Sphere}, CheckerboardMaterial, DebuggerTracer, LinearGRINFresnelMaterial, Scene, Tracer, World
};
...
fn main() {
    ...
    let particle_mat = LinearGRINFresnelMaterial::new(1.4, (0.0,0.001,0.0).into());
    // Setup scene
